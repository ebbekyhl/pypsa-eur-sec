...
rule solve_all_networks:
    input:
        expand(RDIR + "/postnetworks/elec_wy{wyear}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}.nc",
               **config['scenario'])


rule prepare_sector_networks:
    input:
        expand(RDIR + "/prenetworks/elec_wy{wyear}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}.nc",
               **config['scenario'])
...
rule build_clustered_population_layouts:
    ...
    benchmark: "benchmarks/build_clustered_population_layouts/elec_wy{wyear}_s{simpl}_{clusters}"
...
rule build_simplified_population_layouts:
    ...
    resources: mem_mb=10000
    benchmark: "benchmarks/build_clustered_population_layouts/elec_wy{wyear}_s{simpl}"
    script: "scripts/build_clustered_population_layouts.py"
...
rule build_heat_demands:
    ...
    output:
        ...
        heat_demand_total="resources/heat_demand_total_elec_wy{wyear}_s{simpl}_{clusters}.nc"
    resources: mem_mb=20000
    benchmark: "benchmarks/build_heat_demands/elec_wy{wyear}_s{simpl}_{clusters}"
...
rule build_temperature_profiles:
    ...
    output:
        ...
        temp_soil_urban="resources/temp_soil_urban_elec_wy{wyear}_s{simpl}_{clusters}.nc",
        temp_air_total="resources/temp_air_total_elec_wy{wyear}_s{simpl}_{clusters}.nc",
        temp_air_rural="resources/temp_air_rural_elec_wy{wyear}_s{simpl}_{clusters}.nc",
        temp_air_urban="resources/temp_air_urban_elec_wy{wyear}_s{simpl}_{clusters}.nc"
    resources: mem_mb=20000
    benchmark: "benchmarks/build_temperature_profiles/elec_wy{wyear}_s{simpl}_{clusters}"
...
rule build_cop_profiles:
    input:
        ...
        temp_air_urban="resources/temp_air_urban_elec_wy{wyear}_s{simpl}_{clusters}.nc"
    output:
        cop_soil_total="resources/cop_soil_total_elec_wy{wyear}_s{simpl}_{clusters}.nc",
        cop_soil_rural="resources/cop_soil_rural_elec_wy{wyear}_s{simpl}_{clusters}.nc",
        cop_soil_urban="resources/cop_soil_urban_elec_wy{wyear}_s{simpl}_{clusters}.nc",
        cop_air_total="resources/cop_air_total_elec_wy{wyear}_s{simpl}_{clusters}.nc",
        cop_air_rural="resources/cop_air_rural_elec_wy{wyear}_s{simpl}_{clusters}.nc",
        cop_air_urban="resources/cop_air_urban_elec_wy{wyear}_s{simpl}_{clusters}.nc"
    resources: mem_mb=20000
    benchmark: "benchmarks/build_cop_profiles/elec_wy{wyear}_s{simpl}_{clusters}"
...
rule build_solar_thermal_profiles:
    ...
    output:
        ...
        solar_thermal_rural="resources/solar_thermal_rural_elec_wy{wyear}_s{simpl}_{clusters}.nc"
    resources: mem_mb=20000
    benchmark: "benchmarks/build_solar_thermal_profiles/elec_wy{wyear}_s{simpl}_{clusters}"
...
rule build_biomass_potentials:
    ...
    output:
        biomass_potentials_all='resources/biomass_potentials_all_elec_wy{wyear}_s{simpl}_{clusters}.csv',
        biomass_potentials='resources/biomass_potentials_elec_wy{wyear}_s{simpl}_{clusters}.csv'
    threads: 1
    resources: mem_mb=1000
    benchmark: "benchmarks/build_biomass_potentials_elec_wy{wyear}_s{simpl}_{clusters}"
...
rule build_salt_cavern_potentials:
    ...
    threads: 1
    resources: mem_mb=2000
    benchmark: "benchmarks/build_salt_cavern_potentials_elec_wy{wyear}_s{simpl}_{clusters}"
...
rule build_industrial_distribution_key:
    ...
    output:
        industrial_distribution_key="resources/industrial_distribution_key_elec_wy{wyear}_s{simpl}_{clusters}.csv"
    threads: 1
    resources: mem_mb=1000
    benchmark: "benchmarks/build_industrial_distribution_key/elec_wy{wyear}_s{simpl}_{clusters}"
...
rule build_industrial_production_per_node:
    input:
        ...
        industrial_production_per_country_tomorrow="resources/industrial_production_per_country_tomorrow_{planning_horizons}.csv"
    output:
        industrial_production_per_node="resources/industrial_production_elec_wy{wyear}_s{simpl}_{clusters}_{planning_horizons}.csv"
    threads: 1
    resources: mem_mb=1000
    benchmark: "benchmarks/build_industrial_production_per_node/elec_wy{wyear}_s{simpl}_{clusters}_{planning_horizons}"
...
rule build_industrial_energy_demand_per_node:
    input:
        industry_sector_ratios="resources/industry_sector_ratios.csv",
        industrial_production_per_node="resources/industrial_production_elec_wy{wyear}_s{simpl}_{clusters}_{planning_horizons}.csv",
        industrial_energy_demand_per_node_today="resources/industrial_energy_demand_today_elec_wy{wyear}_s{simpl}_{clusters}.csv"
    output:
        industrial_energy_demand_per_node="resources/industrial_energy_demand_elec_wy{wyear}_s{simpl}_{clusters}_{planning_horizons}.csv"
    threads: 1
    resources: mem_mb=1000
    benchmark: "benchmarks/build_industrial_energy_demand_per_node/elec_wy{wyear}_s{simpl}_{clusters}_{planning_horizons}"
...
rule build_industrial_energy_demand_per_node_today:
    ...
    threads: 1
    resources: mem_mb=1000
    benchmark: "benchmarks/build_industrial_energy_demand_per_node_today/elec_wy{wyear}_s{simpl}_{clusters}"
...
if config["sector"]["retrofitting"]["retro_endogen"]:
    rule build_retro_cost:
        input:
            ...
            air_temperature = "resources/temp_air_total_elec_wy{wyear}_s{simpl}_{clusters}.nc",
        ...
        output:
            retro_cost="resources/retro_cost_elec_wy{wyear}_s{simpl}_{clusters}.csv",
            floor_area="resources/floor_area_elec_wy{wyear}_s{simpl}_{clusters}.csv"
        resources: mem_mb=1000
        benchmark: "benchmarks/build_retro_cost/elec_wy{wyear}_s{simpl}_{clusters}"
...
rule build_population_weighted_energy_totals:
    input:
        ...
        clustered_pop_layout="resources/pop_layout_elec_wy{wyear}_s{simpl}_{clusters}.csv"
    output: "resources/pop_weighted_energy_totals_elec_wy{wyear}_s{simpl}_{clusters}.csv"
    threads: 1
    resources: mem_mb=2000
...
rule build_transport_demand:
    input:
        clustered_pop_layout="resources/pop_layout_elec_wy{wyear}_s{simpl}_{clusters}.csv",
        pop_weighted_energy_totals="resources/pop_weighted_energy_totals_elec_wy{wyear}_s{simpl}_{clusters}.csv",
        transport_data='resources/transport_data.csv',
        traffic_data_KFZ="data/emobility/KFZ__count",
        traffic_data_Pkw="data/emobility/Pkw__count",
        temp_air_total="resources/temp_air_total_elec_wy{wyear}_s{simpl}_{clusters}.nc",
    output:
        transport_demand="resources/transport_demand_elec_wy{wyear}_s{simpl}_{clusters}.csv",
        transport_data="resources/transport_data_elec_wy{wyear}_s{simpl}_{clusters}.csv",
        avail_profile="resources/avail_profile_elec_wy{wyear}_s{simpl}_{clusters}.csv",
        dsm_profile="resources/dsm_profile_elec_wy{wyear}_s{simpl}_{clusters}.csv"
    threads: 1
    resources: mem_mb=2000
...
rule prepare_sector_network:
    input:
        ...
        network=pypsaeur('networks/elec_wy{wyear}_s{simpl}_{clusters}_ec_lv{lv}_{opts}.nc'),
        ...
        clustered_pop_layout="resources/pop_layout_elec_wy{wyear}_s{simpl}_{clusters}.csv",
        simplified_pop_layout="resources/pop_layout_elec_wy{wyear}_s{simpl}.csv",
        industrial_demand="resources/industrial_energy_demand_elec_wy{wyear}_s{simpl}_{clusters}_{planning_horizons}.csv",
        heat_demand_urban="resources/heat_demand_urban_elec_wy{wyear}_s{simpl}_{clusters}.nc",
        heat_demand_rural="resources/heat_demand_rural_elec_wy{wyear}_s{simpl}_{clusters}.nc",
        heat_demand_total="resources/heat_demand_total_elec_wy{wyear}_s{simpl}_{clusters}.nc",
        temp_soil_total="resources/temp_soil_total_elec_wy{wyear}_s{simpl}_{clusters}.nc",
        ...
        **build_biomass_transport_costs_output,
        **gas_infrastructure
    output: RDIR + '/prenetworks/elec_wy{wyear}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}.nc'
    threads: 1
    resources: mem_mb=2000
    benchmark: RDIR + "/benchmarks/prepare_network/elec_wy{wyear}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}"
...
rule plot_network:
    input:
        overrides="data/override_component_attrs",
        network=RDIR + "/postnetworks/elec_wy{wyear}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}.nc"
    output:
...
rule make_summary:
    input:
        overrides="data/override_component_attrs",
        networks=expand(
            RDIR + "/postnetworks/elec_wy{wyear}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}.nc",
            **config['scenario']
        ),
        ...
        plots=expand(
            RDIR + "/maps/elec_wy{wyear}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}-costs-all_{planning_horizons}.pdf",
            **config['scenario']
        )
    output:
...
if config["foresight"] == "overnight":
    ...
    rule solve_network:
        input:
            overrides="data/override_component_attrs",
            network=RDIR + "/prenetworks/elec_wy{wyear}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}.nc",
            costs=CDIR + "costs_{}.csv".format(config['costs']['year']),
            config=SDIR + '/configs/config.yaml'
        output: RDIR + "/postnetworks/elec_wy{wyear}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}.nc"
        shadow: "shallow"
        log:
            solver=RDIR + "/logs/elec_wy{wyear}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_solver.log",
            python=RDIR + "/logs/elec_wy{wyear}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_python.log",
            memory=RDIR + "/logs/elec_wy{wyear}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_memory.log"
        threads: config['solving']['solver'].get('threads', 4)
        resources: mem_mb=config['solving']['mem']
        benchmark: RDIR + "/benchmarks/solve_network/elec_wy{wyear}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}"
...
if config["foresight"] == "myopic":
    ...
    rule add_existing_baseyear:
        ...
        output: RDIR + '/prenetworks-brownfield/elec_wy{wyear}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}.nc'
        wildcard_constraints:
            planning_horizons=config['scenario']['planning_horizons'][0] #only applies to baseyear
        threads: 1
        resources: mem_mb=2000
        benchmark: RDIR + '/benchmarks/add_existing_baseyear/elec_wy{wyear}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}'
    ...
    def solved_previous_horizon(wildcards):
        ...
        return RDIR + "/postnetworks/elec_wy{wyear}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_" + planning_horizon_p + ".nc"
    ...
    rule add_brownfield:
        ...
        threads: 4
        resources: mem_mb=10000
        benchmark: RDIR + '/benchmarks/add_brownfield/elec_wy{wyear}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}'
    ...
    rule solve_network_myopic:
        input:
            overrides="data/override_component_attrs",
            network=RDIR + "/prenetworks-brownfield/elec_wy{wyear}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}.nc",
            costs=CDIR + "costs_{planning_horizons}.csv",
            config=SDIR + '/configs/config.yaml'
        output: RDIR + "/postnetworks/elec_wy{wyear}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}.nc"
        shadow: "shallow"
